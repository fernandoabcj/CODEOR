...
def main():
    ...
    if st.button("Executar Conferência", type="primary", use_container_width=True):
        ...
        st.session_state["siafi_df"] = siafi_df
        st.session_state["sipac_df"] = sipac_df
    ...
    siafi_df = st.session_state["siafi_df"]
    sipac_df = st.session_state["sipac_df"]
    nomes_unidades = st.session_state["nomes_unidades"]
    ...
    st.divider()
    show_results(res, nomes_unidades)
